 ...
 * @author    Tom Roper <tomroper2@gmail.com>
 * @license   GPL-2.0+
 * @link      http://example.com
 * @copyright 2016 Tom Roper
 *
 * @wordpress-plugin
 * Plugin Name:       Inhabitent Business Hours
 * Plugin URI:        http://tomsplugins.com
 * Description:       A widget to update the hours for the Inhabitent business website
 * Version:           1.0.0
 * Author:            Tom Roper
 * Author URI:        www.threepeaks.ca
 * License:           GPL-2.0+
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'Update Business hours for Inhabitent.'
			)
		);
